...
<html>
    ...
    <form action="Registro_de_empleados" method="post">

        <p><span style="color:#FF0000" >Primer Apellido</span>
            <input class="contact" type="text" name="Primer_Apellido" value="" /></p>
        <p><span style="color:#FF0000" >Segundo Apellido</span>
            <input class="contact" type="text" name="Segundo_Apellido" value="" /></p>
        <p><span style="color:#FF0000" >Primer Nombre</span>
            <input class="contact" type="text" name="Primer_Nombre" value="" /></p>
        <p><span style="color:#FF0000" >Otros nombres</span>
            <input class="contact" type="text" name="Otros_nombres" value="" /></p>
        ...
        <p><span style="color:#FF0000" >Numero de identificacion</span>
            <input class="contact" type="text" name="Numero_de_identificacion" value="" /></p>
        <p><span style="color:#FF0000" >Fecha de ingreso</span>
            <input class="contact" type="text" name="Fecha_de_ingreso" value="" /></p>
