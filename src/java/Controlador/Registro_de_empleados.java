    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (number == 0) {
                ...
                Registro_de_empleados1 r = new Registro_de_empleados1(Primer_Apellido, Segundo_Apellido, Primer_Nombre, Otros_nombres, Pais_del_empleado, Tipo_de_identificacion, Numero_de_identificacion, Correo_Electronico, Fecha_de_ingreso, Area, Estado, Fecha_y_hora_de_registro);
